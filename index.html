...
<nav class="panel top forceMobileView">
  <div class="sections desktop">
    <div class="left"><a href="#" title="Brand Name"><img src="logo.png" style="width:20%"/></a></div>
    <div class="center">
    <!--
      <ul class="menu">
        <li><a href="#">Tour</a></li>
    ...
    <!--<div class="right"> <a class="button menuButton round" href="#">Profile</a> </div>-->
  </div>
      ...
      <div class="wrap">
        ...
        <div class="fix-10-12">
          <div class="fix-4-12">
            ...
            <!--
            <div class="svgContainer svg-38">
              <svg class="scale ae-1"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use></svg>
            </div>
            -->
          </div>
          <div class="ae-3"><p class="hero"><!--Don&rsquo;t stare at a blank page for too long, be bold, and make the first incisive stroke. The rest will come&nbsp;naturally.-->Thrive with our innovation - a new source, a new way to find wellness in every day life. Coming soon this October. Sign up to be notified</p></div>
          <div>


<!--End mc_embed_signup-->
         
            <form action="https://uniqtech.us19.list-manage.com/subscribe/post?u=f97771fd15831d7ab311796c1&amp;id=1547fc25ec" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" autocomplete="off" class="ae-4 margin-top-4" target="_blank" novalidate>
              <input type="text" class="flat input-38" name="b_f97771fd15831d7ab311796c1_1547fc25ec" placeholder="Email address" value=""/>
              <input type="submit" class="button pink" name="subscribe" value="Get updates" id="mc-embedded-subscribe" value="Subscribe"/>
            </form>

            <!--
            <p class="small margin-top-3 block ae-5">
              Already have an invite code?<br>
              <a href="#"><b>Sign In</b></a>
            </p>
            -->
            <div class="ae-3">
            <p>Update: August 2018 Uniqtech is admitted to the the YC Startup School 2018</p>
            <p>
            We want to hear from you. hi@uniqtech.co 
            </p>
            <p>
            Share your experience using alternative health, dieting and wellness solutions with us.
            </p>
            </div>
          </div>
        </div>
  ...
  <div class="background" style="background-image:url(assets/img/img-38.jpg)"></div>
</section>
